...
| **3️⃣ ABC정리** | 구조적 분석 | 색상별 구분, 호버 효과 |
| **4️⃣ 감정공감** | 마음 이해 | 개선된 선택 UI |
| **5️⃣ 학생조언** | 경험 공유 | 📝 체크리스트 적용 시스템 |
| **6️⃣ 격려완성** | 응원 메시지 | 향상된 결과 화면 |

### **🔄 사용 플로우**
```
시작 → 정보입력 → 고민선택(🤖자동분류) → ABC분석 → 감정공감 → 조언생성(📝체크리스트) → 완성
```
...
*🔄 Version: 2.0.0*
*🏷️ Tags: #교육도구 #ABC모델 #상담 #학생 #교사 #공감 #소통*